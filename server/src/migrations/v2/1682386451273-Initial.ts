...
export class Initial1682386451273 implements MigrationInterface {
  name = 'Initial1682386451273';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "question" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "value" character varying, "stepId" uuid, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "lesson_users_user" ("lessonId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_8b171f8975ffec63c490938a83c" PRIMARY KEY ("lessonId", "userId"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "question" ADD CONSTRAINT "FK_7fdf334f45b9123f59612d9cf9e" FOREIGN KEY ("stepId") REFERENCES "step"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "question" DROP CONSTRAINT "FK_7fdf334f45b9123f59612d9cf9e"`
    );
    await queryRunner.query(
