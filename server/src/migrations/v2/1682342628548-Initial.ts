...
export class Initial1682342628548 implements MigrationInterface {
  name = 'Initial1682342628548';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "role" text DEFAULT 'USER', "profilePic" character varying, "githubId" text, "googleId" text, "username" text NOT NULL, "email" text, "password" text, CONSTRAINT "UQ_0d84cc6a830f0e4ebbfcd6381dd" UNIQUE ("githubId"), CONSTRAINT "UQ_470355432cc67b2c470c30bef7c" UNIQUE ("googleId"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "code_module" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "isEntry" boolean, "code" character varying NOT NULL, "stepId" uuid, "userId" integer, CONSTRAINT "PK_499cf8daf9050fa9510cf065a18" PRIMARY KEY ("uuid"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "code_module" ADD CONSTRAINT "FK_3126c366bff35466d2fd0969286" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "checkpoint" ADD CONSTRAINT "FK_54b53238a8279826f95be669f8d" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "lesson_users_user" ADD CONSTRAINT "FK_5fea17f3ea912b2cafbb1e65f60" FOREIGN KEY ("lessonId") REFERENCES "lesson"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "lesson_users_user" ADD CONSTRAINT "FK_9b085ea6f0570114685cedab8a3" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "checkpoint" DROP CONSTRAINT "FK_54b53238a8279826f95be669f8d"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "code_module" DROP CONSTRAINT "FK_3126c366bff35466d2fd0969286"`
    );
    await queryRunner.query(
