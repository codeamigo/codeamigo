...
export class CodeModuleUseUUID1636984541771 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "code_module" DROP CONSTRAINT IF EXISTS "PK_fb655af374a55cd33dc2af73731"`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "code_module" ADD "id" SERIAL NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "code_module" DROP CONSTRAINT "PK_499cf8daf9050fa9510cf065a18"`
    );
    await queryRunner.query(
      `ALTER TABLE "code_module" ADD CONSTRAINT "PK_fb655af374a55cd33dc2af73731" PRIMARY KEY ("uuid", "id")`
    );
  }
}
