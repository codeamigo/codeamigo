...
const StackblitzTemplate: React.FC<Props> = (props) => {
  ...
  useEffect(() => {
    ...
    const applyDiff = async () => {
      ...
      console.log('applying diff:', { create: diff.create, destroy: [] });
      try {
      ...
      try {
        ...
        console.log('error applying destroy:', e);
      }
    };
  ...
  return (
    <div className="sp-wrapper">
      <div className="sp-layout">
        <div
          className="sm:flex hidden z-20 flex-col justify-between border-r-2 sm:border-b-0 bg-bg-primary border-bg-nav-offset-faded"
          ref={filesRef}
