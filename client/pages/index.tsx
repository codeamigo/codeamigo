  ...
  return (
    <div className="flex w-full items-center justify-between sm:shrink-0">
      <div className="w-full max-w-3xl">
        ...
        <button className=" group hidden select-none items-center gap-2 text-sm font-semibold text-neutral-600 outline-none transition duration-200 ease-in-out hover:text-neutral-600 focus:text-neutral-600 sm:inline-flex">
          Press{' '}
