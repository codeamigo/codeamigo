...
const PrivacyPolicy: React.FC<Props> = () => {
  return (
    <div>
      <h1>Privacy Policy of codeamigo, LLC</h1>

      <p>
        codeamigo, LLC operates the https://codeamigo.dev website, which
      ...
      <p>
        ...
        decided to use our Service, the codeamigo.dev website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at https://codeamigo.dev,
